...
def compare_x2():
    ...
    net_meg = model.rdn_x2(pretrained=True)
    net_meg.eval()

    net_torch = model_pt.rdn_x2()
    net_torch.load_state_dict(torch.load("../weights_pt/rdn_x2.pth", map_location='cpu'))
...
def compare_x3():
    ...
    net_meg = model.rdn_x3(pretrained=True)
    net_meg.eval()

    net_torch = model_pt.rdn_x3()
    net_torch.load_state_dict(torch.load('../weights_pt/rdn_x3.pth', map_location='cpu'))
    net_torch.to(torch_device)
    net_torch.eval()
...
def compare_x4():
    ...
    net_meg = model.rdn_x4(pretrained=True)
    net_meg.eval()

    net_torch = model_pt.rdn_x4()
    net_torch.load_state_dict(torch.load('../weights_pt/rdn_x4.pth', map_location='cpu'))
    net_torch.to(torch_device)
    net_torch.eval()
